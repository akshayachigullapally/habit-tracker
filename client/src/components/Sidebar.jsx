...
import { 
  ...
  FaChevronLeft,
  FaChevronRight,
  FaQuestion, // Use this as a quiz icon replacement
  FaBook, // Or try this alternative
  // FaQuiz removed - doesn't exist in your version of react-icons
} from 'react-icons/fa';
          ...
          <ul className="space-y-1">
            ...
            <li>
              <NavLink
                ...
                title="Quiz"
              >
                <FaQuestion className={`w-5 h-5 ${isCollapsed ? '' : 'mr-3'}`} />
