...
const Dashboard = () => {
  ...
  // Filter habits for the selected view
  const filterHabits = () => {
    if (view === 'daily') return habits;
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <StatsCard 
          ...
          color="amber"
          progress={(user?.experience || 0) / ((user?.level || 1) * 100) * 100}
        />
      </div>
      ...
      {filteredHabits.length > 0 ? (
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-8 text-center">
          <h3 className="text-xl font-medium text-gray-800 dark:text-white mb-2">No habits yet!</h3>
