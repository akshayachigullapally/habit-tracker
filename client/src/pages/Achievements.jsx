...
const Achievements = () => {
  ...
  const achievementTypes = {
    streak: { name: 'Streak Achievements', description: 'Maintain consistent streaks of habit completion' },
    completion: { name: 'Completion Achievements', description: 'Complete habits a certain number of times' },
    level: { name: 'Level Achievements', description: 'Reach specific levels in your journey' },
    community: { name: 'Community Achievements', description: 'Engage with the community and share your progress' }
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {groupedAchievements[type]?.length > 0 ? (
              ...
              <div className="col-span-full text-center p-6 bg-white dark:bg-gray-800 rounded-lg shadow">
                <p className="text-gray-500 dark:text-gray-400">No {name.toLowerCase()} available yet</p>
              </div>
            )}
          </div>
        </div>
